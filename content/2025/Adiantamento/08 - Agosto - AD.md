...
# 📊 Controle Financeiro - Agosto / 2025
...
const reserva10 = totalReceitas * 0.1025;
...
dv.list([
  ...
  `💼 10,25% da Receita (reserva): R$ ${reserva10.toFixed(2)}`,
  `📊 Saldo Final: R$ ${saldoFinal.toFixed(2)}`,
  `🛡️ Saldo após reservar 10,25%: R$ ${saldoComReserva.toFixed(2)}`
]);
